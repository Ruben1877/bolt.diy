...
export function UserMessage({ content, parts }: UserMessageProps) {
      ...
      <div className="overflow-hidden flex flex-col gap-3 items-center ">
        <div className="flex flex-row items-start justify-center overflow-hidden shrink-0 self-start">
          {profile?.avatar || profile?.username ? (
            ...
            <div className="i-ph:user-fill text-bolt-elements-textTertiary text-xl" />
          )}
        </div>
        <div className="flex flex-col gap-4 bg-bolt-elements-background-depth-2 p-4 w-auto rounded-2xl mr-auto">
  ...
  return (
    <div className="flex flex-col bg-bolt-elements-background-depth-2 px-5 p-4 w-auto rounded-2xl ml-auto">
