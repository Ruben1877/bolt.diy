...
function CurrentDateTime() {
  ...
  return (
    <div className="flex items-center gap-2 px-4 py-2 text-sm text-bolt-elements-textTertiary border-b border-bolt-elements-borderColor">
      ...
      >
        <div className="h-12 flex items-center justify-between px-4 border-b border-bolt-elements-borderColor bg-bolt-elements-background-depth-2 rounded-tr-2xl">
          <a href="/" className="flex items-center gap-2 no-underline">
            ...
            <span className="font-semibold text-sm text-bolt-elements-textPrimary tracking-tight">AXTRAAI</span>
          </a>
          <div className="flex items-center gap-2">
            <span className="text-xs text-bolt-elements-textTertiary truncate max-w-[100px]">
              {profile?.username || ''}
            </span>
        ...
        <div className="flex-1 flex flex-col h-full w-full overflow-hidden">
          ...
          <div className="flex items-center justify-between text-sm px-4 py-2">
            <div className="font-medium text-bolt-elements-textTertiary">Vos conversations</div>
            {selectionMode && (
              <div className="flex items-center gap-2">
                ...
                {dialogContent?.type === 'delete' && (
                  <>
                    <div className="p-6 bg-bolt-elements-background-depth-1">
                      <DialogTitle className="text-bolt-elements-textPrimary">Supprimer la conversation ?</DialogTitle>
